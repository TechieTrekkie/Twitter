                ...
                <div class="module">
                    <div class="content-header">
                        <div class="header-inner">
                            <h2 class="js-timeline-title">Who <%=profile_full_name%> Is Following</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    String getAllProfilesQuery = "SELECT login_ID, username, full_name, profile_text FROM login_t WHERE login_ID IN (SELECT followed_ID AS login_ID FROM following_t WHERE follower_ID = ?);";
