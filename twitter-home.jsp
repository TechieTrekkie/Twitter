            ...
            <div class="span8 content-main">
                <div class="module">
                    ...
                    <%
    					...
    					String TweetsToShowQuery = "SELECT * FROM tweets_t WHERE (tweeter_ID IN (SELECT followed_ID FROM following_t WHERE follower_ID=?) OR tweeter_ID=?) AND tweet_ID NOT IN (SELECT reply_ID AS tweet_ID FROM replies_t) ORDER BY publish_date DESC;";
    					...
    					TweetsToShowPS.setString(2, login_ID); // set input parameter
