...
<%
    ...
    //Get number of tweets of profile_ID
    String getProfileNumTweetsQuery = "SELECT count(tweet_ID) FROM tweets_t WHERE tweeter_ID=?";

    java.sql.PreparedStatement getProfileNumTweetsPS = conn.prepareStatement(getProfileNumTweetsQuery); // create a statement
    getProfileNumTweetsPS.setString(1, profile_ID); // set input parameter
    java.sql.ResultSet getProfileNumTweetsRS = getProfileNumTweetsPS.executeQuery();
    
    while (getProfileNumTweetsRS.next())    // extract data from the ResultSet
    {
    	numProfileTweets = getProfileNumTweetsRS.getString("count(tweet_ID)");
    }
        			
    /**********************************************************************/
    
    //Get number of followers of profile_ID
    String getProfileNumFollowersQuery = "SELECT count(follower_ID) FROM following_t WHERE followed_ID=?";

    java.sql.PreparedStatement getProfileNumFollowersPS = conn.prepareStatement(getProfileNumFollowersQuery); // create a statement
    getProfileNumFollowersPS.setString(1, profile_ID); // set input parameter
    java.sql.ResultSet getProfileNumFollowersRS = getProfileNumFollowersPS.executeQuery();
    
    while (getProfileNumFollowersRS.next())    // extract data from the ResultSet
    {
    	numProfileFollowers = getProfileNumFollowersRS.getString("count(follower_ID)");
    }
    
    /**********************************************************************/
    
    //Get number of people profile_ID is following
    String getProfileNumFollowingQuery = "SELECT count(followed_ID) FROM following_t WHERE follower_ID=?";

    java.sql.PreparedStatement getProfileNumFollowingPS = conn.prepareStatement(getProfileNumFollowingQuery); // create a statement
    getProfileNumFollowingPS.setString(1, profile_ID); // set input parameter
    java.sql.ResultSet getProfileNumFollowingRS = getProfileNumFollowingPS.executeQuery();
    
    while (getProfileNumFollowingRS.next())    // extract data from the ResultSet
    {
    	numProfileFollowing = getProfileNumFollowingRS.getString("count(followed_ID)");
    }
    
    /**********************************************************************/
    
    //Get profile_text of people profile_ID
    String getProfileTextQuery = "SELECT profile_text FROM login_t WHERE login_ID=?";

    java.sql.PreparedStatement getProfileTextPS = conn.prepareStatement(getProfileTextQuery); // create a statement
    getProfileTextPS.setString(1, profile_ID); // set input parameter
    java.sql.ResultSet getProfileTextRS = getProfileTextPS.executeQuery();
    
    while (getProfileTextRS.next())    // extract data from the ResultSet
    {
    	profile_text = getProfileTextRS.getString("profile_text");
    }
    ...
    //Check if already following profile_ID tweeting
    String checkIfProfileFollowedQuery = "SELECT count(*) FROM following_t WHERE followed_ID = ? AND follower_ID = ?;";
    java.sql.PreparedStatement checkIfProfileFollowedPS = conn.prepareStatement(checkIfProfileFollowedQuery); // create a statement
    checkIfProfileFollowedPS.setString(1, profile_ID); // set input parameter
    checkIfProfileFollowedPS.setString(2, login_ID); // set input parameter
    java.sql.ResultSet checkIfProfileFollowedRS = checkIfProfileFollowedPS.executeQuery();
    while (checkIfProfileFollowedRS.next())    // extract data from the ResultSet
    {
        timesProfileFollowed = checkIfProfileFollowedRS.getString("count(*)");
    }
    /**********************************************************************/
%>
<!doctype html>
...
<head>
    ...
    <title>Dwitter &middot Profile View</title>
                ...
                <div class="navbar-header">
                    ...
                    <ul class="nav pull-right">
                      <li role="presentation" class="dropdown">
                            <a style="padding-left: 4px;" class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
    ...
    <div class="container wrap">
        <div class="row">
            ...
            <div class="span4" id="secondary">
                <div class="module mini-profile">
                    ...
                    <form action="twitter-posttweet.jsp" class="posttweet" method="post">
                        ...
                        <input type="hidden" name="referer" value="twitter-profile.jsp?profile=<%=profile_ID%>"></input>
            ...
            <div class="span8 content-main">
                <div class="module">
                    <div class="content">
                        <div class="profile-header-inner" data-background-image="url('images/grey-header-web.png')" <%if(profile_text==null||profile_text.replaceAll("\\s+","").length()==0){%>style="height: 180px;"<%}%>>
                            <a href="twitter-profile.jsp?profile=<%=profile_ID%>" class="profile-picture media-thumbnail">
                            	<img class="avatar size90" src='<%="images/avatars/"+profile_ID+".jpg"%>' onerror="this.src='images/avatars/default.png'" alt='<%=profile_full_name%>' height="110" width="110">
                            </a>
                        ...
                        <div class="flex-module profile-banner-footer clearfix">
                            <div class="default-footer">
                                <ul class="stats js-mini-profile-stats" style="float:left">
                                    <li>
                                        <a class="js-nav" href="#">
                                            <strong><%=numProfileTweets%></strong>
                                            Tweets
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <a href="twitter-togglefollower.jsp?followed_id=<%=profile_ID%>&referer=twitter-profile.jsp?profile=<%=profile_ID%>">
                                    <button type="button" class="btn btn-default pull-right">
                                        <span style="margin-top: 2px;" class="<%if(timesProfileFollowed.equals("0")){%>icon-eye-open<%}else{%>icon-eye-close<%}%>"></span>
                                        <%if(timesProfileFollowed.equals("0")){%>Follow<%}else{%>Unfollow<%}%>
                                    </button>
                                </a>
                                <%}%>
                            </div>
                ...
                <div class="module">
                    <div class="content-header">
                        <div class="header-inner">
                            <h2 class="js-timeline-title"><%=profile_full_name%>'s Tweets</h2>
                        </div>
                    </div>
                    ...
                    <%
                        ...
                        String TweetsToShowQuery = "SELECT * FROM tweets_t WHERE (tweeter_ID=?) AND tweet_ID NOT IN (SELECT reply_ID AS tweet_ID FROM replies_t) ORDER BY publish_date DESC;";

                        java.sql.PreparedStatement TweetsToShowPS = conn.prepareStatement(TweetsToShowQuery); // create a statement
                        TweetsToShowPS.setString(1, profile_ID); // set input parameter
                                ...
                                <div class="content">
                                    ...
                                    <span>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="<%if(already_retweeted!=0||tweeter_ID.equals(login_ID)){%>#<%}else{%>twitter-posttweet.jsp?tweet_contents=<%=tweet_content_raw.replaceAll("#", "!!!hash!!!")%>&retweet_id=<%=tweet_ID%>&referer=twitter-profile.jsp?profile=<%=profile_ID%><%}%>">
                                            ...
                                            <a href="twitter-favoritetweet.jsp?tweet_id=<%=tweet_ID%>&referer=twitter-profile.jsp?profile=<%=profile_ID%>">
                                            ...
                                            <a href="<%if(retweeter_ID.equals(login_ID)){%>twitter-deletetweet.jsp?tweet_id=<%=retweeter_tweet_ID%>&referer=twitter-profile.jsp?profile=<%=profile_ID%><%}else{%>twitter-togglefollower.jsp?followed_id=<%=retweeter_ID%>&referer=twitter-profile.jsp?profile=<%=profile_ID%><%}%>">
                                                <button type="button" class="btn btn-xs btn-default" style="padding-left: 12px; padding-right: 12px;padding-bottom: 2px;padding-top: 2px;width: 55.81818175315857px;">
                            ...
                            <div class="twttr-dialog-footer">
                                <span>
                                    <form action="twitter-posttweet.jsp" class="posttweet" method="post" style="margin-bottom: 5px;">
                                        ...
                                        <input type="hidden" name="referer" value="twitter-profile.jsp?profile=<%=profile_ID%>#<%=tweet_ID%>replies"></input>
